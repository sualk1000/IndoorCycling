...
public class GarminConnect {
  ...
  public void resetTokens(Activity currentActivity ) {

    SharedPreferences sharedPreference = currentActivity.getSharedPreferences(currentActivity.getApplicationContext().getPackageName() + ".garmintokens", Context.MODE_PRIVATE);

    SharedPreferences.Editor sharedPreferenceEditor = sharedPreference.edit();
    sharedPreferenceEditor.putString("garminOauth2Token", "");
    sharedPreferenceEditor.putString("garminOauth2RefreshToken", "");
